...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" style="width: 10cm; padding: 5px;" placeholder="Enter Your Email" type="email" required autocomplete="email" autofocus>
...
unset($__errorArgs, $__bag); ?>" style="width: 10cm; padding: 5px;" placeholder="Enter Your Password" type="password" name="password" required autocomplete="current-password">
...
<?php /**PATH D:\Semester-4\Laravel-Framework\praktikum-4\resources\views/auth/login.blade.php ENDPATH**/ ?>