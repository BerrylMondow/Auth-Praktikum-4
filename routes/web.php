...
//edit file (Maybe)
Route::post('/update-cv', 'EmployeeController@update')->name('updateCV');

//delete file
Route::delete('/employees/{employeeId}/delete-file', [EmployeeController::class, 'deleteFile'])->name('employees.deleteFile');
