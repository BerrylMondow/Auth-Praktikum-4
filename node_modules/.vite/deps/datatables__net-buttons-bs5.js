...
// node_modules/datatables.net-buttons-bs5/js/buttons.bootstrap5.mjs
import_jquery2.default.extend(true, dataTables_bootstrap5_default.Buttons.defaults, {
  dom: {
    container: {
  ...
  buttonCreated: function(config, button) {
    return config.buttons ? (0, import_jquery2.default)('<div class="btn-group"/>').append(button) : button;
  }
});
